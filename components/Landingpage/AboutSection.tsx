  ...
  return (
    <section className="bg-[#F9F9F9] text-black px-6 md:px-12 py-24 md:py-40">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        {/* Label - Occupies small space on desktop, full width on mobile */}
        ...
        {/* Main Text - Occupies the right half on desktop */}
        <div className="md:col-start-5 md:col-span-7">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-medium leading-[1.15] tracking-tight">
