        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24 items-start">
          ...
          <Reveal delay={0.1}>
            <div className="flex flex-col gap-6 md:pt-4">
              ...
              <button
                type="button"
                className="bg-[#6366F1] text-white px-8 py-3 rounded-full font-medium w-fit hover:bg-[#4F46E5] transition-colors cursor-pointer"
              >
                Learn more
              </button>
            </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="md:col-span-8 relative">
                <div
                  className={`relative aspect-21/9 md:aspect-3/1 rounded-full overflow-hidden bg-linear-to-r ${step.gradient} p-1`}
                >
