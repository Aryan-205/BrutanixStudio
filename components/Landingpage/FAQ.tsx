  ...
  return (
    <section className="bg-[#F9F9F9] text-black px-6 md:px-12 py-24 md:py-40 border-t border-gray-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12">
        ...
        {/* --- Left Column: Empty space for desktop layout --- */}
        ...
        <div className="md:col-span-8">
          <div className="flex flex-col md:flex-row md:items-start justify-between mb-16 gap-4">
            <h2 className="text-7xl md:text-[120px] font-bold leading-[0.85] tracking-tighter uppercase">
              Common<br />Questions
            </h2>
            <p className="text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] md:pt-4 max-w-[120px]">
