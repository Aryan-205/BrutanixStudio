...
export default function AboutHeroSection() {
  ...
  return (
    <section className="about-mesh relative overflow-hidden px-6 pb-24 pt-32 text-white md:px-12 md:pb-32 md:pt-44">
      ...
      <motion.div
        className="pointer-events-none absolute -right-16 top-8 opacity-[0.07]"
        animate={reduce ? undefined : { y: [0, -12, 0], rotate: [0, 1.5, 0] }}
      ...
      >
        ...
        <h1 className="text-balance text-4xl font-extrabold leading-[1.06] tracking-[-0.04em] sm:text-5xl md:text-6xl lg:text-[3.75rem] bg-gradient-to-r from-white via-white to-brand-lavender bg-clip-text text-transparent">
